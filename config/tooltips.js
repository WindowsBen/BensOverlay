...
const SETTING_TIPS = {
    ...
    shadowSize:        { desc: 'How far the shadow stretches from the text, like a cast shadow at different times of day. Larger values make it a longer trail, not a separate copy of the text.' },
